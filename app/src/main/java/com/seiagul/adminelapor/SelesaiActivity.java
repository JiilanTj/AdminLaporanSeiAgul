    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SelesaiActivity.this);
                dialog.setItems(pilihanAksi, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0:
                                Toast.makeText(SelesaiActivity.this, "Laporan beres, tidak bisa ditangani", Toast.LENGTH_SHORT).show();
